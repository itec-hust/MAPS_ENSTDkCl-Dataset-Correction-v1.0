...
fmin = fmax/1024; %lower boundary for CQT (lowest frequency bin will be immediately above this): fmax/<power of two> 
% fmax = 27.5*2^8;
% fmin=27.5;
...
% x = randn(30*fs,1);
% x=audioread('F:\ScoreInformedPianoTranscription\Dataset\Õæ¸ÖÇÙÒô½×\°ëÒô½×.wav');
